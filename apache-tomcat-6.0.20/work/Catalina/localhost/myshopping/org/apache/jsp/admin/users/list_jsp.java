...
List<Users> list=pDao.read(pageNo, pageSize); 
      ...
      out.write("<body>\r\n");
      out.write("\t\r\n");
      out.write("\t\t<div id=\"ctl\"><a href=\"create.jsp\">新增用户</a></div>\r\n");
      out.write("\t\t\r\n");
 ...
 if(null!=list&&list.size()>0) { 
      ...
      out.write("\t\t\t\t<td>用户注册时间</td>\r\n");
      out.write("\t\t\t\t<td>是否为管理员</td>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t    <td>操作</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( p.getUserPass() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( p.getUserLoginTime() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( p.getIsAdmin() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
